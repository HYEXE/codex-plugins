---
name: uiux-advisor
description: 근거 기반 한국어 UI/UX 가이드를 검색해 개념 설명, 비교, 화면·흐름 리뷰, 컴포넌트·제품 명세, 리서치·검증 계획을 작성한다. 접근성, 콘텐츠, 상호작용 상태, 윤리, 반응형, 디자인 시스템, QA와 성능을 다룰 때 사용한다.
---
...
2. 요청을 `설명`, `비교`, `리뷰`, `명세`, `계획` 중 하나 또는 복수 모드로 분류한다.
...
이미지나 설명에서 확인할 수 없는 키보드, 포커스, 동적 알림, 보조기술, 성능은 **미검증**으로 표시한다.
