...
4. `references/component-toolkit-selection.md`를 읽고 현재 프레임워크와 목적에 맞는 후보를 고른다.
5. registry·copy-paste 코드 통합과 QA는 `references/composition-and-qa.md`를 읽어 적용한다.
